...
namespace TestOkur.WebApi.Migrations
{
    ...
    [Migration("20200627031652_SinglePagePerStudentAddedToOpticalFormDefinition")]
    partial class SinglePagePerStudentAddedToOpticalFormDefinition
    {
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.OpticalFormModel.OpticalFormDefinition", b =>
                {
                    ...
                    b.Property<bool>("SinglePagePerStudent")
                        .HasColumnName("single_page_per_student")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.StudentModel.Student", b =>
                {
                    ...
                    b.Property<string>("CitizenshipIdentity")
                        .HasColumnName("citizenship_identity")
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.OpticalFormModel.OpticalFormTextLocation", b =>
                {
                    ...
                    b.OwnsOne("TestOkur.Domain.Model.OpticalFormModel.Location", "CitizenshipIdentity", b1 =>
                        {
                            ...
                            b1.Property<int>("X")
                                .HasColumnName("citizenship_identity_x")
                                .HasColumnType("integer");

                            b1.Property<int>("Y")
                                .HasColumnName("citizenship_identity_y")
                                .HasColumnType("integer");
