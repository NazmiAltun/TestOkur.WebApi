...
namespace TestOkur.WebApi.Migrations
{
    ...
    [Migration("20190518142120_SmsGroupContacts")]
    partial class SmsGroupContacts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.StudentModel.Contact", b =>
                {
                    ...
                    b.Property<long?>("SmsGroupId")
                        .HasColumnName("sms_group_id");
                    ...
                    b.HasIndex("SmsGroupId")
                        .HasName("ix_contacts_sms_group_id");
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.StudentModel.Contact", b =>
                {
                    b.HasOne("TestOkur.Domain.Model.SmsModel.SmsGroup")
                        .WithMany("Contacts")
                        .HasForeignKey("SmsGroupId")
                        .HasConstraintName("fk_contacts_sms_groups_sms_group_id");
                    ...
                    b.OwnsOne("TestOkur.Domain.Model.Name", "FirstName", b1 =>
                        {
                            ...
                            b1.HasOne("TestOkur.Domain.Model.StudentModel.Contact")
                                .WithOne("FirstName")
                                .HasForeignKey("TestOkur.Domain.Model.Name", "ContactId")
