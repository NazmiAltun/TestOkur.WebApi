...
namespace TestOkur.WebApi.Migrations
{
    ...
    [Migration("20190402104909_ExamScanSessionAdded")]
    partial class ExamScanSessionAdded
    {
...
#pragma warning disable 612, 618
            modelBuilder
                ...
                .HasAnnotation("Relational:Sequence:.sms_seq", "'sms_seq', '', '1', '10', '', '', 'Int64', 'False'")
                .HasAnnotation("Relational:Sequence:.subjects_seq", "'subjects_seq', '', '1', '10', '', '', 'Int64', 'False'")
                .HasAnnotation("Relational:Sequence:.templates_seq", "'templates_seq', '', '1', '10', '', '', 'Int64', 'False'")
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.LessonModel.SubjectName", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.SettingModel.Template", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                        .HasAnnotation("Npgsql:HiLoSequenceName", "templates_seq")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SequenceHiLo);
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.SmsModel.Sms", b =>
                {
                    b.Property<int>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("user_id");
                    ...
                    b.Property<long>("Id")
                        .HasColumnName("id")
                        .HasAnnotation("Npgsql:HiLoSequenceName", "sms_seq")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.SequenceHiLo);
                    ...
                    b.OwnsOne("TestOkur.Domain.Model.Name", "Name", b1 =>
                        {
                            ...
                            b1.HasOne("TestOkur.Domain.Model.LessonModel.SubjectName")
                                .WithOne("Name")
                    ...
                    b.OwnsOne("TestOkur.Domain.Model.Name", "Name", b1 =>
                        {
                            ...
                            b1.HasOne("TestOkur.Domain.Model.SettingModel.Template")
                                .WithOne("Name")
                                .HasForeignKey("TestOkur.Domain.Model.Name", "TemplateId")
                                .HasConstraintName("fk_templates_templates_id")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
            ...
            modelBuilder.Entity("TestOkur.Domain.Model.SmsModel.Sms", b =>
                {
                    b.OwnsOne("TestOkur.Domain.Model.Phone", "Receiver", b1 =>
                        {
                            b1.Property<int>("SmsUserId")
                                .HasColumnName("user_id");

                            b1.Property<string>("Value")
                                .IsRequired()
                                .HasColumnName("receiver_value")
                                .HasMaxLength(20);
                            ...
                            b1.HasOne("TestOkur.Domain.Model.SmsModel.Sms")
                                .WithOne("Receiver")
                                .HasForeignKey("TestOkur.Domain.Model.Phone", "SmsUserId")
                                .HasConstraintName("fk_smses_smses_user_id")
                                .OnDelete(DeleteBehavior.Cascade);
                        });
                });
